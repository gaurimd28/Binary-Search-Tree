...
The goal of this project is to demonstrate how a Binary Search Tree works internally — including how nodes are inserted, deleted, and traversed using different algorithms.
